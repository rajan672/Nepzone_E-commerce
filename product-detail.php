            ...
            <div class="col-md-7 bg-light" id="part-2">
              ...
              <form id="login-form">
                <div class="form-group">
                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email,Mobile no">
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-top">
      ...
      <div class="collapse navbar-collapse text-center" id="navbarNav">
        ...
        <ul class="navbar-nav m-auto">
          <li class="nav-itemss ">
            <a class="nav-link" href="search-filter-page.php">TOP OFFERS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="search-filter-page.php">GROCERY</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="search-filter-page.php">MOBILES</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container-fluid s-main">
    <div class="row bg-light mb-3 shadow-sm first-row">
      ...
      <div class="col-md-7">
        ...
        <h5 class="font-baloo font-size-20"> <?php echo $row['mob_name'] ?> </h5>
        <small>by <?php echo $row['mob_brand'] ?></small>
        <div class="d-flex">
          ...
          <a href="#" class="px-2 font-rale font-size-14"> <?php echo $row['mob_rating']  ?> </a>
        </div>
        <hr class="m-0">
        <!---product price -->
        <table class="my-3">
          <tr class="font-rale font-size-14">
            <td>M.R.P:</td>
            <td><strike><?php echo $row['mob_market_price']  ?></strike></td>
          </tr>
          <tr class="font-rale font-size-14">
            <td>Deal Price:</td>
            <td class="font-size-20 text-danger">NRP.<span> <?php echo $row['mob_selling_price'] ?> </span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
          </tr>
          <tr class="font-rale font-size-14">
            <td>You Save:</td>
            <td><span class="font-size-16 text-danger">NRP. <?php echo $row['mob_yousave_price'] ?></span></td>
          </tr>
        </table>
        <!---    !product price       -->
