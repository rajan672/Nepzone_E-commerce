...
<body>
    ...
    if (isset($_GET['id'])) {
        $lap_id = $_GET['id'];
        $sql = "SELECT * FROM laptops WHERE id = '$lap_id'";
    ...
    <div class="container-fluid s-main">
        <div class="row bg-light mb-3 shadow-sm first-row">
                        ...
                        <div class="simpleLens-container">
                            <div class="simpleLens-big-image-container">
                                <a class="simpleLens-lens-image" data-lens-image="">
                                    <img src=" .<?php echo str_replace('..', '.', $row['lap_image'])  ?> " class="simpleLens-big-image">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <h4 class="font-baloo font-size-20"> <?php echo $row['lap_name'] ?> </h4>
                <h6>by <?php echo $row['lap_brand'] ?></h6>
                <span class="badge badge-success badge-block"><i class="fas fa-star"></i> <?php echo $row['lap_rating']  ?> </span> <span class="text-secondary"> (<?php echo $row['lap_review'] ?>)Review </span> <br>
                <span class="text-success"><small> <strong> <?php echo  $row['lap_discount'] ?> % Off</strong> </small></span>
                <ul class="pl-3 text-secondary pro-details-li">
                    <li> <?php echo $row['lap_desc1'] ?> </li>
                    <li><?php echo $row['lap_desc2'] ?></li>
                    <li><?php echo $row['lap_desc3'] ?></li>
                    <li><?php echo $row['lap_desc4'] ?></li>
                    <li><?php echo $row['lap_desc5'] ?></li>
                    <li><?php echo $row['lap_desc6'] ?></li>
                    <li><?php echo $row['lap_desc7'] ?></li>
                </ul>
                <!---product price -->
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>M.R.P:</td>
                        <td><strike><?php echo $row['lap_market_price']  ?></strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-danger">NRP.<span> <?php echo $row['lap_selling_price'] ?> </span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">NRP. <?php echo $row['lap_yousave_price'] ?></span></td>
                    </tr>
                </table>
                <!---    !product price       -->
