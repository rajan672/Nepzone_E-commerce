...
<body>
    ...
    if (isset($_GET['id'])) {
        $mens_id = $_GET['id'];
        $sql = "SELECT * FROM men_shoes WHERE id = '$mens_id'";
    ...
    <div class="container-fluid s-main">
        <div class="row bg-light mb-3 shadow-sm first-row">
                        ...
                        <div class="simpleLens-container">
                            <div class="simpleLens-big-image-container">
                                <a class="simpleLens-lens-image" data-lens-image="">
                                    <img src=" .<?php echo str_replace('..', '.', $row['mens_image'])  ?> " class="simpleLens-big-image">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <h5 class="font-baloo font-size-20"> <?php echo $row['mens_name'] ?> </h5>
                <small>by <?php echo $row['mens_brand'] ?></small>
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14"> <?php echo $row['mens_rating']  ?> </a>
                </div>
                <hr class="m-0">
                <!---product price -->
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>M.R.P:</td>
                        <td><strike><?php echo $row['mens_market_price']  ?></strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-danger">NRP.<span> <?php echo $row['mens_selling_price'] ?> </span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">NRP. <?php echo $row['mens_yousave_price'] ?></span></td>
                    </tr>
                </table>
                <!---    !product price       -->
