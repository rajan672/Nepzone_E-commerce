...
<body>
    ...
    if (isset($_GET['id'])) {
        $mob_id = $_GET['id'];
        $sql = "SELECT * FROM mobiles WHERE id = '$mob_id'";
    ...
    <div class="container-fluid s-main">
        <div class="row bg-light mb-3 shadow-sm first-row">
            <div class="col-md-5">
                        ...
                        <div class="simpleLens-container">
                            <div class="simpleLens-big-image-container">
                                <a class="simpleLens-lens-image" data-lens-image="">
                                    <img src=" .<?php echo str_replace('..', '.', $row['mob_image'])  ?> " class="simpleLens-big-image">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="../cart-page.php" type="submit" name="addToCart" class="btn btn-warning btn-lg text-light btn-block"><i class="fa fa-shopping-cart"></i> Add To Cart</a>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-7">
                ...
                <h4 class="font-baloo font-size-20"> <?php echo $row['mob_name'] ?> </h4>
                <h6>by <?php echo $row['mob_brand'] ?></h6>
                <span class="badge badge-success badge-block"><i class="fas fa-star"></i> <?php echo $row['mob_rating']  ?> </span> <span class="text-secondary"> (<?php echo $row['mob_review'] ?>) </span> <br>
                <span class="text-success"><small> <strong> <?php echo $row['mob_discount'] ?> % Off</strong> </small></span>
                <!---product price -->
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>Market Price:</td>
                        <td><strike class="text-danger"> NRP. <?php echo $row['mob_market_price']  ?></strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-primary">NRP.<span> <?php echo $row['mob_selling_price'] ?> </span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-primary">NRP. <?php echo $row['mob_yousave_price'] ?></span></td>
                    </tr>
                </table>
                <!---    !product price       -->
                ...
                <div class="row">
                    <div class="tabs_div ">
                        <h3 class="text-center font-rale">Specifications</h3>
                        <ul>
                            <li class="text-primary font-rale">Display</li>
                            <li class="text-primary font-rale">Camera</li>
                            <li class="text-primary font-rale">Hardware</li>
                            <li class="text-primary font-rale">Battery</li>
                            <li class="text-primary font-rale">Phone features</li>
                        </ul>
                        <div>
                            <table class="table font-rale">
                                <tbody>
                                    <tr>
                                        <td class="success">Physical size: </td>
                                        <td> <?php echo $row['mob_size']  ?> inches</td>
                                    </tr>
                                    <tr>
                                        <td class="success">Resolution: </td>
                                        <td> <?php echo $row['mob_resolution']  ?> </td>
                                    </tr>
                                    <!-- <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo $row['mob_technology']  ?> </td>
                                    </tr>
                                   <!--  <tr>
                        ...
                        <div>
                            <table class="table font-rale">
                                <tbody>
                                    <tr>
                                        <td class="success"> Front-Camera: </td>
                                        <td> <?php echo $row['mob_front_camera']  ?> megapixels</td>
                                    </tr>
                                    <tr>
                                        <td class="success"> Back-Camera: </td>
                                        <td> <?php echo $row['mob_back_camera']  ?> megapixels</td>
                                    </tr>
                                    <tr>
                                        <td class="success">Flash: </td>
                                        <td> <?php echo $row['mob_flash']  ?> </td>
                                    </tr>
                                    <!-- <tr>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="row" id="gradient">
                    <div class="col-md-4">
                        <img src="<?php echo $row['mob_image'] ?>" class="img-fluid">
                    </div>
