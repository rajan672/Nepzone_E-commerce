...
$record = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM earphones"));
$pagi = ceil($record / $per_page);

$sql = "SELECT * FROM earphones ORDER BY id DESC limit $start,$per_page";
            ...
            <div class="section-1-top">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Earphones & Headphones</li>
                </ol>
              </nav>
            </div>
                  ...
                  while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    echo '
                        <div class="col-md-3 col-sm-4 col-6">
                          <a href="../product-details/earphones-product.php?id=' . $ep_id . '" class="product">
                            <div class="product-top">
                              <i class="fa fa-heart float-right"></i>
                              <img class="img-fluid" src=".' . str_replace('..', '.', $row['ep_image']) . '" alt="">
                            </div>

                            <div class="product-bottom">
                              <div class="product-desc-top">
                                <div class="product-brand text-secondary">' . $row['ep_brand'] . '</div>
                                <div class="product-desc text-dark">' . $row['ep_name'] . '</div>
                                <div class="product-price">
                                  <span><strong> NRP. ' . $row['ep_selling_price'] . ' </strong></span> <br>
                                  <span class="text-secondary"><strike> NRP.' . $row['ep_market_price'] . '  </strike></span> <br>
                                  <span class="text-success"><small> <strong> ' . $row['ep_discount'] . '% Off</strong> </small></span>
                                </div>
                              </div>
                              <div class="product-desc-bottom">
                                <div class="product-desc-extra">
                                  <span class="badge badge-success"> ' . $row['ep_rating'] . ' <i class="fas fa-star"></i></span> <span class="text-secondary"> (' . $row['ep_review'] . ') </span> <br>
