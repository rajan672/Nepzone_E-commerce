...
$record = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM laptops"));
$pagi = ceil($record / $per_page);

$sql = "SELECT * FROM laptops ORDER BY id DESC limit $start,$per_page";
                        ...
                        <div class="section-1-center">
                            ...
                            if (mysqli_num_rows($res) > 0) {
                                while ($row = mysqli_fetch_assoc($res)) {
                                    $lap_id = $row['id'];
                                    echo '
                                        <a href=" ../product-details/laptop-product.php?id=' . $lap_id . ' " class="row text-body border laptop-pro">
                                            <div class="col-md-3 col-sm-3 col-3">
                                                <i class="fa fa-heart float-right"></i>
                                                <img class="img-fluid m-1 " src=" .' . str_replace('..', '.', $row['lap_image']) . ' " alt="">
                                            </div>
                                            <div class="col-md-5 col-sm-5 col-5">
                                                <h5 class="h5"> ' . $row['lap_name'] . ' </h5> <br>
                                                <span class="badge badge-success"> ' . $row['lap_rating'] . ' <i class="fas fa-star"></i></span> <span class="text-secondary"> (' . $row['lap_review'] . ')Review </span> <br>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-4 text-center mt-4">
                                                <h4 class="h4"> NRP. ' . $row['lap_selling_price'] . ' </h4>
                                                <h6 class="text-secondary"><strike> NRP.' . $row['lap_market_price'] . '  </strike></h6>
                                                <span class="text-success"><small> <strong> ' . $row['lap_discount'] . '% Off</strong> </small></span>
                                            </div>
                                        </a>
                                    ';
                                }
