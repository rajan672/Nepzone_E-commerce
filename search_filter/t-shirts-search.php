...
$record=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM t_shirts"));
$pagi=ceil($record/$per_page);

$sql="SELECT * FROM t_shirts ORDER BY id DESC limit $start,$per_page";
                  ...
                  while ($row = mysqli_fetch_assoc($res)) { 
                    ...
                    echo '
                        <div class="col-md-3 col-sm-4 col-6">
                          <a href="../product-details/t-shirts-product.php?id=' . $t_id . '" class="product">
                            <div class="product-top">
                              <i class="fa fa-heart float-right"></i>
                              <img class="img-fluid" src=".' . str_replace('..', '.', $row['t_image']) . '" alt="">
                            </div>

                            <div class="product-bottom">
                              <div class="product-desc-top">
                                <div class="product-brand text-secondary">' . $row['t_brand'] . '</div>
                                <div class="product-desc text-dark">' . $row['t_name'] . '</div>
                                <div class="product-price">
                                  <span><strong> NRP. ' . $row['t_selling_price'] . ' </strong></span> <br>
                                  <span class="text-secondary"><strike> NRP.' . $row['t_market_price'] . '  </strike></span> <br>
                                  <span class="text-success"><small> <strong> ' . $row['t_discount'] . '% Off</strong> </small></span>
                                </div>
                              </div>
                              <div class="product-desc-bottom">
                                <div class="product-desc-extra">
                                  <span class="badge badge-success"> ' . $row['t_rating'] . ' <i class="fas fa-star"></i></span> <span class="text-secondary"> (' . $row['t_review'] . ') </span> <br>
