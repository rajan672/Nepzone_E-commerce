                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add Data in Deals of the day</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                //update
                                if (isset($_REQUEST['adddealBtn'])) {
                                    //checking for empty field
                                    if (($_REQUEST['deal_name'] == "") || ($_REQUEST['deal_brand'] == "") || ($_REQUEST['deal_selling_price'] == "") || ($_REQUEST['deal_market_price'] == "") || ($_REQUEST['deal_yousave_price'] == "") || ($_REQUEST['deal_discount'] == "") || ($_REQUEST['deal_rating'] == "") || ($_REQUEST['deal_review'] == "") || ($_REQUEST['deal_desc'] == "")) {
                                        ...
                                        $deal_img_temp = $_FILES['deal_img']['tmp_name'];
                                        $img_folder ='../image/offer_deals/'.$deal_img;
                                        move_uploaded_file($deal_img_temp, $img_folder);

                                        $sql = "INSERT INTO offer_deals(deal_name , deal_brand , deal_selling_price , deal_market_price , deal_yousave_price  ,deal_discount ,deal_rating ,deal_review ,deal_desc , deal_image ) 
                                        VALUES ('$dealname' , '$dealbrand' , '$dealsp' , '$dealmp' , '$dealsavep' , '$dealdis' , '$dealrat' , '$dealrev' , ' $dealdesc' , '$deal_img') ";
                                        if ($conn->query($sql) == TRUE) {
                                            //below msg display on form submit success
                                            $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2" role="alert"> Product added Successfully !</div>';
                                        } else {
                                            //below msg display on form submit failed
                                            $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert">Unable to Add the product !</div>';
                                        }
                                    }
                                }
                                ?>
                                <div class="col-sm6 mt-5 mx-3 jumbotron">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="deal_brand" name="deal_brand" row="2">
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_selling_price" class="font-weight-bold p-1">Deal Selling Price <small>(in NRP.)</small> </label>
                                            <input type="text" class="form-control" id="deal_selling_price" name="deal_selling_price" row="2"> 
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_market_price" class="font-weight-bold p-1">Deal Market Price <small>(in NRP.)</small> </label>
                                            <input type="text" class="form-control" id="deal_market_price" name="deal_market_price" row="2">
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_yousave_price" class="font-weight-bold p-1">Deal Saved Price <small>(in NRP.)</small> </label>
                                            <input type="text" class="form-control" id="deal_yousave_price" name="deal_yousave_price" row="2"> 
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_discount" class="font-weight-bold p-1">Deal Discount <small>(in %)</small> </label>
                                            <input type="text" class="form-control" id="deal_discount" name="deal_discount" row="2"> 
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_rating" class="font-weight-bold p-1">Deal Rating <small>(out of 5 start)</small> </label>
                                            <input type="text" class="form-control" id="deal_rating" name="deal_rating" row="2">
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_review" class="font-weight-bold p-1">Deal Review <small>(in numbers)</small> </label>
                                            <input type="text" class="form-control" id="deal_review" name="deal_review" row="2"> 
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_desc" class="font-weight-bold p-1">Deal Description <small>( about product in words)</small> </label>
                                            <textarea type="text" class="form-control" id="deal_desc" name="deal_desc" row="2"> </textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_register" class="font-weight-bold p-1">Deal Register Time and Date <small>( about product date & time)</small> </label>
                                            <input type="datetime-local" class="form-control" id="deal_register" name="deal_register">
                                        </div>

                                        <div class="form-group">
                                            <label for="deal_img" class="font-weight-bold p-1">Deal image</label>
                                            <input type="file" class="form-control-file" id="deal_img" name="deal_img">
                                        </div>

                                        

                                        <div class="text-center">
                                            <button type="submit" class="btn btn-danger" id="adddealBtn" name="adddealBtn">Submit</button>
